...
all_blueprints = {
    ...
    "unitree-go2-dan-holonomic-benchmark": "dimos.robot.unitree.go2.blueprints.basic.unitree_go2_dan_holonomic_benchmark:unitree_go2_dan_holonomic_benchmark",
    "unitree-go2-dan-holonomic-controller": "dimos.robot.unitree.go2.blueprints.basic.unitree_go2_dan_holonomic_controller:unitree_go2_dan_holonomic_controller",
    ...
    "unitree-go2-path-follower-benchmark": "dimos.robot.unitree.go2.blueprints.basic.unitree_go2_path_follower_benchmark:unitree_go2_path_follower_benchmark",
    "unitree-go2-path-follower-controller": "dimos.robot.unitree.go2.blueprints.basic.unitree_go2_path_follower_controller:unitree_go2_path_follower_controller",
